...
| Raspberry Pi 4 Model B (4GB) | 1 | $82.79 | [Amazon](https://www.amazon.com/Raspberry-Pi-RPI4-MODBP-4GB-Model-4GB/dp/B09TTNF8BT) |
**Total cost : $86.79**
...
## Compatibility
Fits Raspberry Pi (update with your exact model, e.g. 4B).

## Notes
Feel free to remix or modify in Fusion 360 — GPIO, camera, and port cutouts are all editable.
